...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'data', true, true);
   ...
   loadPackage({"files": [{"filename": "/data/dummy", "start": 0, "end": 0, "audio": 0}], "remote_package_size": 0, "package_uuid": "ec3a3abe-48d4-4596-b7cf-14935720b053"});
...
var ASM_CONSTS = {
  22599: function() {var canvas = document.getElementById('canvas'); canvas.style.width = (canvas.width / window.devicePixelRatio) + 'px'; canvas.style.height = (canvas.height / window.devicePixelRatio) + 'px';},  
 23339: function() {setTimeout(function() { var canvas = document.getElementById('canvas'); canvas.style.width = (canvas.width / window.devicePixelRatio) + 'px'; canvas.style.height = (canvas.height / window.devicePixelRatio) + 'px'; }, 0);}
};
